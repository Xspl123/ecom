                                ...
                                <div class="img-wrapper">
                                    <div class="front">
                                        <a href="product/nihil-beatae-sit-sed.html">
                                            <img src="assets/images/fashion/product/front/{{$item->image}}"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="back">
                                        <a href="product/nihil-beatae-sit-sed.html">
                                            <img src="assets/images/fashion/product/back/{{$item->image}}"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="cart-wrap">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="main-price">
                                        ...
                                        <div class="listing-content">
                                            <span class="font-light grid-content">{{ $item->category->name ?? '' }}</span>
                                            <p class="font-light">{{$item->short_description}}</p>
                                        </div>
                                        <h3 class="theme-color">${{$item->regular_price}}</h3>
