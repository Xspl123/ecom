                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> +91 7982748233</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> B-86, Sec-60 Noida, Utter-Pradesh,
                                            India</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> abhishek@vert-age.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2023, Vert-Age.</p>
                    </div>
                </div>
            </div>
        </div>
